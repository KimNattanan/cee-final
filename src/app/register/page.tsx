...
export default function Register() {
  return (
    <div className="relative min-h-screen w-full bg-[url('/img/background_2.jpg')] bg-cover bg-center bg-no-repeat">
      <div className="flex min-h-screen w-full flex-col space-y-5 bg-gradient-to-bl from-pink-500/50 via-fuchsia-500/50 to-blue-400/50 p-4 text-cyan-50 md:p-8">
