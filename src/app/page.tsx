...
export default function Home() {
  ...
  return (
    <div className="w-screen min-h-screen bg-[url('/img/background_1.jpg')] bg-cover bg-center bg-no-repeat text-3xl text-gray-50 flex flex-col overflow-hidden"> 
      ...
      <h1 className="justify-self-center p-5 h-25 content-center text-center text-5xl font-extrabold text-animate-color-change bg-amber-50/80">-SpellCam-</h1>
